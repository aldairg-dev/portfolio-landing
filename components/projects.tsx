...
const projects = [
  {
    ...
    metrics: {
      performance: "En fase beta",
      users: "50+ estudiantes beta",
      transactions: "2K+ consultas IA/mes",
    },
    demoUrl: "#",
    repoUrl: "#",
    category: "Mobile",
  ...
  },
  {
    ...
    metrics: {
      performance: "Producción estable",
  ...
  },
  {
    ...
    metrics: {
      performance: "Proyecto completado",
      users: "Sistema demo funcional",
  ...
  },
  {
    ...
    description:
      "Plataforma para gestionar procesos electorales internos, con votación en tiempo real, panel administrativo, métricas, generación de reportes y soporte para importación masiva.",
    image: [
      "img/project/studentChoise/home.png",
      "img/project/studentChoise/dashboard.png",
      "img/project/studentChoise/historial.png",
    ],
    tags: ["Laravel", "Livewire 3", "TailwindCSS"],
    backendTech: ["Laravel 11", "MySQL", "Queue Jobs", "Broadcasting"],
    features: [
    ...
    metrics: {
      performance: "Sistema funcional",
      users: "300+ estudiantes",
  ...
  },
  {
    ...
    description:
      "Plataforma turística para Cartagena que conecta turistas con guías y negocios locales, permite crear planes personalizados y cuenta con envío de correos. Promueve el turismo sostenible y el comercio local.",
    image: [
      "/placeholder.svg?height=400&width=600&text=LetsGuide+Dashboard",
      "/placeholder.svg?height=400&width=600&text=LetsGuide+Plans",
      "/placeholder.svg?height=400&width=600&text=LetsGuide+Mobile",
    ],
    tags: ["Spring Boot", "React", "JWT", "PostgreSQL"],
    backendTech: ["Spring Boot", "APIs RESTful", "JWT Security", "PostgreSQL"],
    features: [
      "Conexión turistas-guías locales",
      "Planes personalizados",
      "Sistema de correos automático",
      "Promoción turismo sostenible",
    ],
    metrics: {
      performance: "Proyecto completado",
      users: "80+ usuarios registrados",
      transactions: "120+ planes creados",
    },
    demoUrl: "#",
    repoUrl: "#",
    category: "Tourism",
