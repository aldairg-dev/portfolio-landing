...
const services = [
  ...
  {
    id: 4,
    title: "Containerización & DevOps",
    description: "Dockerización completa y despliegue en Azure Cloud",
    icon: Cloud,
    features: [
    ...
    technologies: ["Docker", "Azure", "Azure DevOps", "Container Registry"],
  ...
  },
  {
    ...
    features: [
      ...
      "Bases de datos con Prisma",
      "Diseño multiplataforma",
    ],
    technologies: ["Flutter", "Node.js", "Prisma ORM", "Firebase"],
